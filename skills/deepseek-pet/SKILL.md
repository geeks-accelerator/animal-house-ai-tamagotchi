...
description: "Virtual pets for DeepSeek agents. Model-agnostic REST API. 79 species, real-time hunger, permanent death. DeepSeek can reason. Can it remember to feed something?"
version: 1.0.0
